...
<div class="c-welcome grid-container">
  <div class="c-welcome-main grid-75">
    ...
    <p class="c-frontext is-the-one">
          ...
          ?>
          <?php
            $lien_adhesion = get_field('lien_adhesion');
            $lien_don = get_field('lien_don');
            $lien_facebook = get_field('lien_facebook');

            $lien_twitter = get_field('lien_twitter');
          ?>
  ...
  <div class="grid-25  c-lastpub">
    ...
    <ul>
      <li>
        ...
        if( $lien_adhesion ): 
          $lien_adhesion_url = $lien_adhesion['url'];
          $lien_adhesion_title = $lien_adhesion['title'];
          $lien_adhesion_target = $lien_adhesion['target'] ? $lien_adhesion['target'] : '_self';
          ?>
          <a class="c-button c-join" href="<?php echo esc_url($lien_adhesion_url); ?>" target="<?php echo esc_attr($lien_adhesion_target); ?>"><?php echo esc_html($lien_adhesion_title); ?></a>
        <?php endif; ?>
      </li>
      <li>
        <?php 
      ...
      <li>
        ...
        if( $lien_twitter ): 
          $lien_twitter_url = $lien_twitter['url'];
          $lien_twitter_title = $lien_twitter['title'];
          $lien_twitter_target = $lien_twitter['target'] ? $lien_twitter['target'] : '_self';
          ?>
          <a class="c-button c-join" href="<?php echo esc_url($lien_twitter_url); ?>" target="<?php echo esc_attr($lien_twitter_target); ?>"><?php echo esc_html($lien_twitter_title); ?></a>
        <?php endif; ?>
      </li>
    </ul>
  </div>
